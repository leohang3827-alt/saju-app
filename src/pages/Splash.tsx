  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        width: '120%',
        height: '120%',
        backgroundImage: 'radial-gradient(rgba(192, 157, 91, 0.15) 1px, transparent 1px)',
        backgroundSize: '24px 24px',
        pointerEvents: 'none',
        zIndex: 1
      }} />

      {/* Decorative Cloud Vectors (Chinese traditional style) */}
      <div style={{
        position: 'absolute',
        top: '12%',
        left: '-30px',
      ...
      <DraggableWrapper id="splash_title_v3" defaultOffset={{ x: 0, y: 0 }} style={{ width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        <div style={{
          display: 'flex',
          flexDirection: 'column',
          alignItems: 'center',
          ...
          <FanDeco size={44} style={{ marginBottom: '10px', filter: 'drop-shadow(0 4px 8px rgba(0,0,0,0.3))' }} />
      ...
      {/* Middle Section: Main Character with Gold Halo */}
      <DraggableWrapper id="splash_char_v3" defaultOffset={{ x: 0, y: 0 }}>
        <div style={{
          position: 'relative',
          width: '260px',
          height: '260px',
      ...
      <DraggableWrapper id="splash_footer_v3" defaultOffset={{ x: 0, y: 0 }} style={{ width: '100%' }}>
        <div style={{
          width: '100%',
          zIndex: 5,
          display: 'flex',
